...
if __name__ == "__main__":
    ...
    # text_data = [
    #     {"text": "INT2/EXT", "coord": (379, 132, 507, 142), "category": "芯片", "conf": 0.5308},
    #     {"text": "SDA/SPI_M", "coord": (208, 112, 277, 122), "category": "芯片", "conf": 0.5773},
    #     {"text": "SPI CS B", "coord": (379, 111, 478, 121), "category": "芯片", "conf": 0.3968},
    #     {"text": "I2C_SCL", "coord": (34, 138, 75, 150), "category": "芯片", "conf": 0.5408},
    #     {"text": "SAQ/SPI", "coord": (210, 91, 278, 100), "category": "芯片", "conf": 0.5773},
    #     {"text": "INT2/EXT_T", "coord": (550, 140, 620, 150), "category": "芯片", "conf": 0.5773},
    #     {"text": "INTVMOT", "coord": (380, 90, 450, 100), "category": "芯片", "conf": 0.5773},
    #     {"text": "SCL/SCL", "coord": (229, 133, 279, 142), "category": "芯片", "conf": 0.5318},
    #     {"text": "1GND", "coord": (379, 26, 402, 35), "category": "芯片", "conf": 0.6118},
    #     {"text": "Vdo", "coord": (257, 25, 278, 35), "category": "芯片", "conf": 0.531},
    #     {"text": "BT MODE", "coord": (231, 69, 278, 78), "category": "芯片", "conf": 0.4391},
    #     {"text": "12C SA0", "coord": (35, 96, 75, 107), "category": "芯片", "conf": 0.4812},
    #     {"text": "INTF_SEL", "coord": (379, 52, 425, 62), "category": "芯片", "conf": 0.5632},
    #     {"text": "INT1", "coord": (550, 97, 570, 106), "category": "芯片", "conf": 0.5773},
    #     {"text": "1.0μF", "coord": (166, 59, 191, 68), "category": "芯片", "conf": 0.5773},
    #     {"text": "PC_SDA", "coord": (35, 117, 75, 128), "category": "芯片", "conf": 0.5773},
    #     {"text": "- WAKE UP", "coord": (549, 118, 598, 128), "category": "芯片", "conf": 0.3643},
    #     {"text": "V00", "coord": (94, 3, 114, 13), "category": "芯片", "conf": 0.5664},
    #     {"text": ",", "coord": (138, 60, 149, 68), "category": "芯片", "conf": 0.8573},
    #     {"text": "988-04082", "coord": (572, 159, 618, 167), "category": "芯片", "conf": 0.5544},
    #     {"text": "V00", "coord": (467, 3, 488, 13), "category": "芯片", "conf": 0.5664},
    #     {"text": "0.1 μF", "coord": (209, 59, 233, 68), "category": "芯片", "conf": 0.4391},
    #     {"text": ",", "coord": (485, 54, 495, 62), "category": "芯片", "conf": 0.8573},
    #     {"text": "C2", "coord": (164, 49, 177, 57), "category": "电容", "conf": 0.3547},
    #     {"text": ",", "coord": (517, 54, 528, 62), "category": "芯片", "conf": 0.8573},
    #     {"text": "R3", "coord": (109, 60, 121, 68), "category": "芯片", "conf": 0.9014},
    #     {"text": ",", "coord": (284, 119, 289, 126), "category": "芯片", "conf": 0.8573},
    #     {"text": ",", "coord": (208, 49, 219, 57), "category": "芯片", "conf": 0.8573},
    #     {"text": "la", "coord": (283, 76, 289, 84), "category": "芯片", "conf": 0.5773},
    #     {"text": "10", "coord": (363, 33, 374, 41), "category": "芯片", "conf": 0.5773},
    #     {"text": ",", "coord": (368, 139, 375, 147), "category": "芯片", "conf": 0.8573},
    #     {"text": ",", "coord": (284, 97, 289, 105), "category": "芯片", "conf": 0.8573},
    #     {"text": "la", "coord": (283, 139, 289, 147), "category": "芯片", "conf": 0.5773},
    #     {"text": ",", "coord": (369, 60, 375, 68), "category": "芯片", "conf": 0.8573},
    #     {"text": ",", "coord": (368, 97, 375, 105), "category": "芯片", "conf": 0.8573},
    # ]
    
    # # ========== 新元件数据 ==========
    # component_data = [
    #     {"category": "line", "bbox": (379, 37, 433, 63), "segmentation": [[428, 38], [428, 43], [429, 44], [429, 61], [430, 62], [431, 61], [432, 61], [432, 60], [433, 59], [433, 50]], "conf": 0.94},
    #     {"category": "chip", "bbox": (251, 25, 402, 158), "segmentation": [[281, 23], [281, 27], [281, 28], [281, 34], [280, 35], [280, 37], [279, 38], [280, 39], [280, 46], [281, 47]], "conf": 0.93},
    #     {"category": "line", "bbox": (481, 32, 513, 48), "segmentation": [[481, 31], [481, 32], [481, 33], [507, 34], [508, 34], [510, 37], [510, 44], [511, 45], [516, 45], [516, 31]], "conf": 0.91},
    #     {"category": "resistor", "bbox": (128, 49, 137, 84), "segmentation": [[127, 53], [127, 77], [135, 77], [136, 76], [136, 75], [136, 74], [136, 55], [135, 53]], "conf": 0.90},
    #     {"category": "ground", "bbox": (153, 85, 166, 92), "segmentation": [[153, 85], [153, 90], [156, 90], [158, 92], [158, 95], [160, 95], [160, 92], [164, 87], [164, 85]], "conf": 0.88},
    #     {"category": "ground", "bbox": (425, 75, 438, 81), "segmentation": [[423, 74], [423, 77], [426, 77], [426, 78], [427, 78], [430, 81], [430, 84], [430, 81], [431, 80], [432, 80]], "conf": 0.87},
    #     {"category": "resistor", "bbox": (507, 43, 516, 78), "segmentation": [[506, 47], [506, 72], [511, 72], [512, 71], [513, 71], [514, 70], [515, 70], [516, 69], [519, 69], [519, 48]], "conf": 0.86},
    #     {"category": "resistor", "bbox": (475, 42, 484, 79), "segmentation": [[473, 46], [473, 71], [477, 71], [479, 69], [481, 69], [482, 70], [487, 70], [487, 48], [484, 48], [483, 47]], "conf": 0.85},
    #     {"category": "resistor", "bbox": (100, 47, 109, 83), "segmentation": [[102, 53], [102, 76], [112, 76], [112, 53]], "conf": 0.85},
    #     {"category": "capacitor", "bbox": (153, 52, 165, 69), "segmentation": [[153, 52], [153, 64], [157, 64], [159, 66], [159, 67], [160, 66], [160, 65], [161, 64], [162, 64], [163, 63]], "conf": 0.78},
    #     {"category": "line", "bbox": (478, 70, 481, 101), "segmentation": [[477, 70], [477, 102], [483, 102], [483, 70]], "conf": 0.76},
    #     {"category": "capacitor", "bbox": (195, 52, 208, 69), "segmentation": [[196, 52], [196, 64], [199, 64], [200, 65], [201, 65], [202, 66], [202, 67], [203, 66], [203, 65], [205, 63]], "conf": 0.69},
    #     {"category": "line", "bbox": (132, 77, 134, 144), "segmentation": [[131, 86], [131, 145], [137, 145], [137, 86]], "conf": 0.58},
    #     {"category": "line", "bbox": (510, 70, 513, 146), "segmentation": [[509, 70], [509, 143], [516, 143], [516, 70]], "conf": 0.55},
    #     {"category": "line", "bbox": (131, 38, 134, 54), "segmentation": [[131, 38], [131, 55], [137, 55], [137, 38]], "conf": 0.51},
    # ]
