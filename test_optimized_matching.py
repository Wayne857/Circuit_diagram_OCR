...
def test_optimized_matching():
    ...
    text_data = [
        ...
        {'text': 'NC', 'coord': (100, 100, 120, 120), 'category': '芯片', 'conf': 0.4},  # 低置信度，应该被过滤
        {'text': 'CT', 'coord': (110, 110, 130, 130), 'category': '电容', 'conf': 0.3},  # 低置信度，应该被过滤
        {'text': 'MR', 'coord': (200, 50, 220, 70), 'category': '芯片', 'conf': 0.45},  # 低置信度，应该被过滤
        {'text': 'VDD', 'coord': (150, 100, 180, 120), 'category': '芯片', 'conf': 0.85},  # 合格置信度
    ]
